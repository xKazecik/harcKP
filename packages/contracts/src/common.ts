/**
 * Schematy bazowe współdzielone przez pozostałe moduły kontraktów.
 *
 ...
 *
 * Moduł celowo nie importuje niczego z index.ts — index jest wyłącznie
 * barrelem re-eksportów, co eliminuje cykl importów (TDZ przy ESM).
 */
import { z } from 'zod';
